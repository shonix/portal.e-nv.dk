(function () {
  ...
  window.PortalData = {
    ...
    partnerMaterials:async function(){return (await request("partner-materials")).materials;},
    uploadPartnerMaterial:function(fields){var data=new FormData();Object.keys(fields).forEach(function(key){data.append(key,fields[key])});return request("admin-upload-partner-material",{method:"POST",body:data});},
    deletePartnerMaterial:function(materialId){return post("admin-delete-partner-material",{materialId:materialId});},
